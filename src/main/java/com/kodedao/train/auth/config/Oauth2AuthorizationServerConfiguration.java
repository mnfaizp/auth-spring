package com.kodedao.train.auth.config;

import com.kodedao.train.auth.view.Oauth2ClientDetailService;
import com.kodedao.train.auth.view.Oauth2UserDetailService;
