...
import com.kodedao.train.auth.model.RolePath;
import com.kodedao.train.auth.model.User;
import com.kodedao.train.auth.repository.ClientRepository;
import com.kodedao.train.auth.repository.RolePathRepository;
import com.kodedao.train.auth.repository.RoleRepository;
...
public class DatabaseSeeder implements ApplicationRunner {
    ...
    private String[] users = new String[]{
            "admin:ROLE_SUPERUSER ROLE_USER ROLE_ADMIN",
            "user:ROLE:USER"
    };
    ...
    public void insertClients(String password) {
        for (String client: clients) {
            ...
            String[] clientRoles = str[1].split("\\s");
